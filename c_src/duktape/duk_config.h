...
/* Timeout check callback - implemented in duktape_nif.c */
extern int duktape_check_timeout(void *udata);
#define DUK_USE_EXEC_TIMEOUT_CHECK(udata) duktape_check_timeout(udata)
